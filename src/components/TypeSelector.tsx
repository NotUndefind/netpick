          ...
          return (
            <motion.button
              ...
              className={`
                ...
                ${isSelected
                  ? 'border-transparent bg-gradient-to-r text-white shadow-lg ' + type.color
                  : disabled
              ...
              `}
              whileHover={!disabled && !isSelected ? { scale: 1.02, y: -2 } : {}}
            ...
            >
              ...
              {!isSelected && !disabled && (
                <motion.div
                  ...
                  style={{ background: `linear-gradient(to right, ${type.color.split(' ')[1]}, ${type.color.split(' ')[3]})` }}
